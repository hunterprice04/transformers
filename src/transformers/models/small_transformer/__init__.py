...
_import_structure = {
    "configuration_small_transformer": ["SMALL_TRANSFORMER_PRETRAINED_CONFIG_ARCHIVE_MAP", "SmallTransformerConfig", "SmallTransformerOnnxConfig"],
}
...
try:
    ...
    _import_structure["modeling_small_transformer"] = [
...
try:
    ...
    _import_structure["modeling_tf_small_transformer"] = [
...
if TYPE_CHECKING:
    from .configuration_small_transformer import SMALL_TRANSFORMER_PRETRAINED_CONFIG_ARCHIVE_MAP, SmallTransformerConfig, SmallTransformerOnnxConfig
    ...
    try:
        ...
        from .modeling_small_transformer import (
            SMALL_TRANSFORMER_PRETRAINED_MODEL_ARCHIVE_LIST,
            SmallTransformerDoubleHeadsModel,
            SmallTransformerForSequenceClassification,
            SmallTransformerForTokenClassification,
    ...
    try:
        ...
        from .modeling_tf_small_transformer import (
            TF_SMALL_TRANSFORMER_PRETRAINED_MODEL_ARCHIVE_LIST,
            TFSmallTransformerDoubleHeadsModel,
            TFSmallTransformerForSequenceClassification,
            TFSmallTransformerLMHeadModel,
